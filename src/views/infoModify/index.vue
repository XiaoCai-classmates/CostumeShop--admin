<template>
    <el-card class="form-container" shadow="hover">
        <el-form :model="infoModifyForm" :rules="rules" ref="infoModifyForm">
            <el-form-item label="头像上传:" prop="profile" :label-width="formLabelWidth">
                <el-upload class="avatar-uploader"
                    ...
                    <img v-if="infoModifyForm.avatarSrc" :src="infoModifyForm.avatarSrc" class="avatar">
                    <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                </el-upload>
                <i class="span">请点击头像上传</i>
            </el-form-item>
            <el-form-item label="店铺名称:" prop="store_Name" :label-width="formLabelWidth">
                <el-input type="" autocomplete="on" v-model="infoModifyForm.store_Name"></el-input>
            </el-form-item>
            <el-form-item label="店铺地址:" prop="store_adress" :label-width="formLabelWidth">
                <el-input type="" autocomplete="on" v-model="infoModifyForm.store_adress"></el-input>
            </el-form-item>
            <el-form-item label="店铺介绍:" prop="store_introduction" :label-width="formLabelWidth">
                <el-input type="textarea" autocomplete="on" v-model="infoModifyForm.store_introduction"></el-input>
            </el-form-item>
            <el-form-item label="联系方式:" prop="contact" :label-width="formLabelWidth">
                <el-input type="" autocomplete="on" v-model="infoModifyForm.contact"></el-input>
            </el-form-item>
            <el-form-item label="店铺所在区:" prop="region" :label-width="formLabelWidth">
                <el-input type="" autocomplete="on" v-model="infoModifyForm.region"></el-input>
            </el-form-item>
            <el-form-item label="店主姓名:" prop="name" :label-width="formLabelWidth">
                <el-input type="" autocomplete="on" v-model="infoModifyForm.name"></el-input>
            </el-form-item>
            <el-form-item class="btn">
                <el-button @click="reset('infoModifyForm')">重置</el-button>
                <el-button type="primary" @click="submitForm(infoModifyForm)">确认修改</el-button>
            </el-form-item>
        </el-form>
    </el-card>
</template>
...
export default {
    name: "infoModify",
    data() {
        let store_introduction = (rule, value, callback) => {
        ...
        return {
            ...
            rules: {
                ...
                contact: [
                    ...
                    { validator: store_introduction, trigger: "blur" },
                ],
                region: [
    ...
    methods: {
        reset(infoModifyForm) {
            this.$refs.infoModifyForm.resetFields()
        },
        submitForm(infoModifyForm) {
            this.$refs.infoModifyForm.validate((valid) => {
                if (valid) {
                    ...
                    let data = this.infoModifyForm
                    addInfoModify({
                        id: data.id,
                        name: data.store_Name,
                        avatar: data.avatar,
                        address: data.store_adress,
                        desc: data.store_introduction,
                        tel: data.contact,
                        region: data.region,
                        real_name: data.name,
                    })
        ...
        handleAvatarSuccess(res, file) {
            this.infoModifyForm.avatarSrc = URL.createObjectURL(file.raw);
            // this.infoModifyForm.avatarSrc = file.response.files;
        },
    ...
    created() {
       ...
       ​
            ...
            this.infoModifyForm.region = res.data.data[0].region
            this.infoModifyForm.name = res.data.data[0].real_name
